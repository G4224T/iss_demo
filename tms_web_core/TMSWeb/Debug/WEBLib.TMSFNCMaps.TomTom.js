rtl.module("WEBLib.TMSFNCMaps.TomTom",["System"],function () {
  "use strict";
  var $mod = this;
  var $impl = $mod.$impl;
  this.RegisterTomTomService = function () {
    if (!pas["WEBLib.TMSFNCMaps"].TTMSFNCMapsPlatformServices.Current().SupportsPlatformService$1(rtl.getIntfGUIDR(pas["WEBLib.TMSFNCMaps"].ITMSFNCMapsServiceTomTom),{p: $impl, get: function () {
        return this.p.MapsService;
      }, set: function (v) {
        rtl.setIntfP(this.p,"MapsService",v);
      }})) {
      rtl.setIntfP($impl,"MapsService",rtl.queryIntfT($impl.TTMSFNCMapsTomTomService.$create("Create$1"),pas["WEBLib.TMSFNCMaps"].ITMSFNCMapsServiceTomTom),true);
      pas["WEBLib.TMSFNCMaps"].TTMSFNCMapsPlatformServices.Current().AddPlatformService(rtl.getIntfGUIDR(pas["WEBLib.TMSFNCMaps"].ITMSFNCMapsServiceTomTom),$impl.MapsService);
    };
  };
  this.UnRegisterTomTomService = function () {
    pas["WEBLib.TMSFNCMaps"].TTMSFNCMapsPlatformServices.Current().RemovePlatformService(rtl.getIntfGUIDR(pas["WEBLib.TMSFNCMaps"].ITMSFNCMapsServiceTomTom));
  };
  $mod.$implcode = function () {
    ...
    $impl.REL_VER = 1;
    $impl.BLD_VER = 0;
    $mod.$rtti.$Class("TTMSFNCMapsTomTomService");
    rtl.createClass($impl,"TTMSFNCMapsTomTomFactoryService",pas["WEBLib.TMSFNCMaps"].TTMSFNCMapsFactoryService,function () {
      rtl.addIntf(this,pas["WEBLib.TMSFNCMaps"].ITMSFNCMapsServiceTomTom);
      rtl.addIntf(this,pas["WEBLib.TMSFNCMaps"].ITMSFNCMapsService);
      rtl.addIntf(this,pas.System.IUnknown);
    });
    rtl.createClass($impl,"TTMSFNCMapsTomTomService",$impl.TTMSFNCMapsTomTomFactoryService,function () {
      this.DoCreateMaps = function () {
        var Result = null;
        var $ok = false;
        try {
          Result = rtl.setIntfL(Result,rtl.queryIntfT($impl.TTMSFNCMapsTomTom.$create("Create$1"),pas["WEBLib.TMSFNCMaps"].ITMSFNCCustomMaps),true);
          $ok = true;
        } finally {
    ...
    $mod.$rtti.$Class("TTMSFNCMapsTomTom");
    rtl.createClass($impl,"TTMSFNCMapsTomTom",pas["WEBLib.TMSFNCMaps"].TTMSFNCCustomMapsInterfacedObject,function () {
      this.GetHeadLinks = function (AList) {
        AList.Add$1(pas["WEBLib.TMSFNCMaps"].TTMSFNCMapsLink.$create("CreateLink",[$impl.TOMTOMAPIURL + $impl.TOMTOMAPIVERSION + "/maps/maps.css","text/css","stylesheet"]));
        AList.Add$1(pas["WEBLib.TMSFNCMaps"].TTMSFNCMapsLink.$create("CreateScript",[$impl.TOMTOMAPIURL + $impl.TOMTOMAPIVERSION + "/maps/maps-web.min.js","","","",false,false]));
      };
      ...
      this.GetInitializeMap = function () {
        ...
        try {
          ...
          Result = "  " + pas["WEBLib.TMSFNCMaps"].MAPVAR + " = " + v + ".map({" + pas["WEBLib.TMSFNCMaps"].LB + '    key: "' + $ir.ref(1,this.GetMapsProperties()).GetAPIKey() + '",' + pas["WEBLib.TMSFNCMaps"].LB + '    container: "' + pas["WEBLib.TMSFNCMaps"].MAPID + '",' + pas["WEBLib.TMSFNCMaps"].LB + '    style: "' + $impl.TOMTOMMAPSTYLE + '",' + pas["WEBLib.TMSFNCMaps"].LB + "    center: [" + $ir.ref(2,this.GetMapsProperties()).GetDefaultLongitude() + ", " + $ir.ref(3,this.GetMapsProperties()).GetDefaultLatitude() + "]," + pas["WEBLib.TMSFNCMaps"].LB + "    zoom: " + $ir.ref(4,this.GetMapsProperties()).GetDefaultZoomLevel() + pas["WEBLib.TMSFNCMaps"].LB + "  });" + pas["WEBLib.TMSFNCMaps"].LB + pas["WEBLib.TMSFNCMaps"].LB;
          ...
          Result = Result + "  " + pas["WEBLib.TMSFNCMaps"].MAPVAR + ".setLanguage('" + $ir.ref(9,this.GetMapsProperties()).GetLocale(pas["WEBLib.TMSFNCMapsCommonTypes"].TTMSFNCMapsLocaleMode.mlmDefault) + "');";
        } finally {
          $ir.free();
        };
        return Result;
      ...
      this.GetUpdateOptions = function () {
        ...
        Result = Result + "  " + pas["WEBLib.TMSFNCMaps"].MAPVAR + ".setLanguage('' + " + pas["WEBLib.TMSFNCMaps"].PARAMSNAME + '["Locale"] + \'\');';
        return Result;
      };
    ...
    $impl.TOMTOMAPIVERSION = "6.x/6.23.0";
    $impl.TOMTOMAPIURL = "https://api.tomtom.com/maps-sdk-for-web/cdn/";
    $impl.TOMTOMMAPSTYLE = "https://api.tomtom.com/style/1/style/21.1.0-*?map=basic_main&poi=poi_main";
    $impl.MAPSERVICEVAR = "window.tt";
    $impl.MAPZOOMCONTROLVAR = "mapZoomControl";
    $impl.MAPCONTROLARRAYVAR = "mapControls";
  };
},["Classes","Math","DateUtils","Types","SysUtils","WEBLib.TMSFNCMaps","WEBLib.TMSFNCMapsCommonTypes","WEBLib.TMSFNCUtils","WEBLib.TMSFNCTypes","contnrs","Web"]);
//# sourceMappingURL=WEBLib.TMSFNCMaps.TomTom.js.map
