...
rtl.module("program",["System","WEBLib.Forms","WEBLib.Forms","Unit1"],function () {
  ...
  $mod.$implcode = function () {
    ...
    pas.System.$rtti["TArray<Generics.Collections.TPair<System.String,System.TObject>>"].eltype = pas["Generics.Collections"].$rtti["TPair<System.String,System.TObject>"];
    pas["Generics.Collections"].TEnumerator$G25.$initSpec();
    pas.System.$rtti["TArray<WEBLib.TMSFNCPersistence.TTMSFNCObjectReference>"].eltype = pas["WEBLib.TMSFNCPersistence"].$rtti["TTMSFNCObjectReference"];
    pas["Generics.Collections"].TEnumerable$G24.$initSpec();
    pas["Generics.Collections"].$rtti["TCollectionNotifyEvent<WEBLib.TMSFNCPersistence.TTMSFNCObjectReference>"].init();
    pas["Generics.Defaults"].IComparer$G22.$initSpec();
    pas["Generics.Collections"].TCustomArrayHelper$G16.$initSpec();
    pas["Generics.Collections"].TArrayHelper$G15.$initSpec();
    pas["Generics.Collections"].TCustomList$G14.$initSpec();
    pas["Generics.Collections"].TCustomListEnumerator$G12.$initSpec();
    pas["Generics.Defaults"].IEnumerator$G9.$initSpec();
    pas["Generics.Defaults"].IEnumerable$G8.$initSpec();
    pas["Generics.Collections"].TList$G7.$initSpec();
    pas["Generics.Collections"].TObjectList$G2.$initSpec();
    pas["Generics.Collections"].TEnumerator$G26.$initSpec();
    pas.System.$rtti["TArray<WEBLib.TMSFNCPersistence.TTMSFNCJSONToClassProperty>"].eltype = pas["WEBLib.TMSFNCPersistence"].$rtti["TTMSFNCJSONToClassProperty"];
    pas["Generics.Collections"].TEnumerable$G25.$initSpec();
    pas["Generics.Collections"].$rtti["TCollectionNotifyEvent<WEBLib.TMSFNCPersistence.TTMSFNCJSONToClassProperty>"].init();
    pas["Generics.Defaults"].IComparer$G23.$initSpec();
    pas["Generics.Collections"].TCustomArrayHelper$G17.$initSpec();
    pas["Generics.Collections"].TArrayHelper$G16.$initSpec();
    pas["Generics.Collections"].TCustomList$G15.$initSpec();
    pas["Generics.Collections"].TCustomListEnumerator$G13.$initSpec();
    pas["Generics.Defaults"].IEnumerator$G10.$initSpec();
    pas["Generics.Defaults"].IEnumerable$G9.$initSpec();
    pas["Generics.Collections"].TList$G8.$initSpec();
    pas["Generics.Collections"].TObjectList$G3.$initSpec();
    pas["Generics.Collections"].TEnumerator$G27.$initSpec();
    pas.System.$rtti["TArray<WEBLib.TMSFNCPersistence.TTMSFNCJSONToClassItem>"].eltype = pas["WEBLib.TMSFNCPersistence"].$rtti["TTMSFNCJSONToClassItem"];
    pas["Generics.Collections"].TEnumerable$G26.$initSpec();
    pas["Generics.Collections"].$rtti["TCollectionNotifyEvent<WEBLib.TMSFNCPersistence.TTMSFNCJSONToClassItem>"].init();
    pas["Generics.Defaults"].IComparer$G24.$initSpec();
    pas["Generics.Collections"].TCustomArrayHelper$G18.$initSpec();
    pas["Generics.Collections"].TArrayHelper$G17.$initSpec();
    pas["Generics.Collections"].TCustomList$G16.$initSpec();
    pas["Generics.Collections"].TCustomListEnumerator$G14.$initSpec();
    pas["Generics.Defaults"].IEnumerator$G11.$initSpec();
    pas["Generics.Defaults"].IEnumerable$G10.$initSpec();
    pas["Generics.Collections"].TList$G9.$initSpec();
    pas["Generics.Collections"].TObjectList$G4.$initSpec();
    ...
    pas["Generics.Defaults"].$rtti["TOnComparison<WEBLib.TMSFNCPersistence.TTMSFNCJSONToClassProperty>"].init();
    pas["Generics.Defaults"].TComparer$G3.$initSpec();
    pas["Generics.Defaults"].TDefaultComparer$G3.$initSpec();
    pas["Generics.Defaults"].TDelegatedComparerEvents$G3.$initSpec();
    pas["Generics.Collections"].TEnumerator$G29.$initSpec();
    pas.System.$rtti["TArray<WEBLib.TMSFNCWebBrowser.TTMSFNCWebBrowserContextMenuItem>"].eltype = pas["WEBLib.TMSFNCWebBrowser"].$rtti["TTMSFNCWebBrowserContextMenuItem"];
    pas["Generics.Collections"].TEnumerable$G28.$initSpec();
    pas["Generics.Collections"].$rtti["TCollectionNotifyEvent<WEBLib.TMSFNCWebBrowser.TTMSFNCWebBrowserContextMenuItem>"].init();
    pas["Generics.Defaults"].IComparer$G25.$initSpec();
    pas["Generics.Collections"].TCustomArrayHelper$G19.$initSpec();
    pas["Generics.Collections"].TArrayHelper$G18.$initSpec();
    pas["Generics.Collections"].TCustomList$G17.$initSpec();
    pas["Generics.Collections"].TCustomListEnumerator$G15.$initSpec();
    pas["Generics.Defaults"].IEnumerator$G12.$initSpec();
    pas["Generics.Defaults"].IEnumerable$G11.$initSpec();
    pas["Generics.Collections"].TList$G10.$initSpec();
    pas["Generics.Collections"].TObjectList$G5.$initSpec();
  };
  $mod.$main = function () {
...
//# sourceMappingURL=iss_demo.js.map
