rtl.module("System",[],function () {
  ...
  this.$rtti.$DynArray("TArray<Generics.Collections.TPair<System.String,System.TObject>>",{});
  this.$rtti.$DynArray("TArray<System.TObject>",{eltype: this.$rtti["TObject"]});
  this.$rtti.$DynArray("TArray<System.String>",{eltype: rtl.string});
  this.$rtti.$DynArray("TArray<System.Double>",{eltype: rtl.double});
  this.$rtti.$DynArray("TArray<WEBLib.TMSFNCPersistence.TTMSFNCObjectReference>",{});
  this.$rtti.$DynArray("TArray<WEBLib.TMSFNCPersistence.TTMSFNCJSONToClassProperty>",{});
  this.$rtti.$DynArray("TArray<WEBLib.TMSFNCPersistence.TTMSFNCJSONToClassItem>",{});
  this.$rtti.$DynArray("TArray<Generics.Collections.TPair<System.String,System.String>>",{});
  this.$rtti.$DynArray("TArray<WEBLib.TMSFNCWebBrowser.TTMSFNCWebBrowserContextMenuItem>",{});
